...
{
	console.log("car1");
	document.getElementsById('gameStatus').innerHTML = "Carro 1 Venceu!!";
}
else if(car2X > 700)
{
	console.log("car2");
	document.getElementsById('gameStatus').innerHTML = "Carro 2 Venceu!!";
}
...
function car1_up()
{
	...
	{
		car1Y = car1Y - 10;
		console.log("Quando a seta para cima é precionada, x = " + car1X + " | y " +car1Y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car1_left()
{
	...
	{
		car1Y = car1Y - 10;
		console.log("Quando a seta para esquerda é precionada, x = " + car1X + " | y " +car1Y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car1_right()
{
	...
	{
		car1X = car1X +10;
		console.log("Quando a seta para direita é precionada, x = " + car1X + " | y " +car1Y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car2_down()
{
	...
	{
		car2Y = car2Y - 10;
		console.log("Quando a seta para cima é precionada, x = " + car2X + " | y " +car2Y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car2_up()
{
	...
	{
		car2Y = car2Y + 10;
		console.log("Quando a seta para baixo é precionada, x = " + car2X + " | y " +car2Y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car2_right()
{
	...
	{
		car2Y = car2Y + 10;
		console.log("Quando a seta para direita é precionada, x = " + car2X + " | y " +car2Y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car2_left()
{
	...
	{
		car2Y = car2Y - 10;
		console.log("Quando a seta para esquerda é precionada, x = " + car2X + " | y " +car2Y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
